...
public class PlayingFiled extends AppCompatActivity {
    ...
    private void performAction(ImageView imageView, int i) {
        ...
        TextView scorePlayer1 = findViewById(R.id.scoreX);
        TextView scorePlayer2 = findViewById(R.id.scoreY);

        if (activePlayer == 1) {
            imageView.setImageResource(R.drawable.ximage);

            if(checkResult()){
                ResultDialog resultDialog = new ResultDialog(PlayingFiled.this, playerOneName.getText().toString() + " is a Winner!", PlayingFiled.this);
                resultDialog.setCancelable(false);
                resultDialog.show();

                currentScoreOne++;
                scorePlayer1.setText(String.valueOf(currentScoreOne));

            } else if(totalSelectedBoxes == 8){
                ResultDialog resultDialog = new ResultDialog(PlayingFiled.this, "Match Draw", PlayingFiled.this);
                resultDialog.setCancelable(false);
                resultDialog.show();
            } else {
                changePlayerTurn(2);
            ...
            if(checkResult()){
                ResultDialog resultDialog = new ResultDialog(PlayingFiled.this, playerTwoName.getText().toString() + " is a Winner!", PlayingFiled.this);
                resultDialog.setCancelable(false);
                resultDialog.show();

                currentScoreTwo++;
                scorePlayer2.setText(String.valueOf(currentScoreTwo));
            } else if(totalSelectedBoxes == 8){
                ResultDialog resultDialog = new ResultDialog(PlayingFiled.this, "Match Draw", PlayingFiled.this);
                resultDialog.setCancelable(false);
                resultDialog.show();
    ...
    private void changePlayerTurn(int currentPlayer) {
        activePlayer = currentPlayer;

        LinearLayout playerOneLayoutOuter = findViewById(R.id.playerOneLayout);
        LinearLayout playerTwoLayoutOuter = findViewById(R.id.playerTwoLayout);
