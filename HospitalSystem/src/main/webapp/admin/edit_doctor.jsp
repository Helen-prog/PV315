                ...
                <div>
                    ...
                    <form action="../updateDoctor" method="post">
                        <div class="mb-3">
                            ...
                            <input type="text" name="full_name" id="full" class="form-control" required value="<%= doc.getFullName() %>">
                        </div>
                        <div class="mb-3">
                            <label for="dob" class="form-label">Дата рождения</label>
                            <input type="date" name="dob" id="dob" class="form-control" required value="<%= doc.getDob() %>">
                        </div>
                        <div class="mb-3">
                            <label for="qualif" class="form-label">Квалификация</label>
                            <input type="text" name="qualification" id="qualif" class="form-control" required value="<%= doc.getQualification() %>">
                        </div>
                        <div class="mb-3">
                            <label for="special" class="form-label">Специалист</label>
                            <select name="spec" id="special" class="form-control" required>
                                <option value=""><%= doc.getSpecialist() %></option>
                                <%
                            ...
                            <div class="mb-3">
                                ...
                                <input type="email" name="email" id="email" class="form-control" required value="<%= doc.getEmail() %>">
                            </div>

                            <div class="mb-3">
                                <label for="tel" class="form-label">Телефон</label>
                                <input type="text" name="mobno" id="tel" class="form-control" required value="<%= doc.getMobNo() %>">
                            </div>

                            <div class="mb-3">
                                <label for="psw" class="form-label">Пароль</label>
                                <input type="password" name="password" id="psw" class="form-control" required value="<%= doc.getPassword() %>">
                            </div>
